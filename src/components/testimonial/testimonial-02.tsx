...
const Testimonial = ({ title, description, name, designation, image, className }: TProps) => {
    return (
        <div
            className={clsx(
                "testimonial tw:h-full tw:rounded-sm tw:bg-white tw:px-5 tw:py-7.5 tw:md:pb-9 tw:md:pl-[50px] tw:md:pr-7.5 tw:md:pt-[41px]",
                className
            )}
        >
            ...
            <div className="tw:inline-flex tw:flex-wrap tw:items-center tw:pt-1 tw:md:pt-6">
                {image?.src && (
