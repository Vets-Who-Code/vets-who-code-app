    ...
    return (
        <a
            className={clsx(
                ...
                "before:tw-ease-[cubic-bezier(.71,1.7,.77,1.24)] before:tw-pointer-events-none before:tw-invisible before:tw-absolute before:tw-bottom-full before:tw-z-20 before:tw-mb-[-13px] before:tw-border-[7px] before:tw-border-transparent before:tw-border-t-primary before:tw-opacity-0 before:tw-transition-all before:tw-duration-300 before:tw-content-[''] before:left-[calc(50%_-_7px)",
