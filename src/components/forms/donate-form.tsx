...
const DonateForm = forwardRef<HTMLDivElement, TProps>(({ className }, ref) => {
    return (
        <div
            className={clsx("tw:flex tw:flex-col tw:gap-8 tw:py-10 tw:lg:flex-row", className)}
            ref={ref}
        >
            {/* Donation form column */}
            <div className="tw:w-full tw:lg:w-full">
                <div className="tw:flex tw:flex-col tw:overflow-hidden tw:rounded-lg tw:bg-white tw:shadow-lg tw:md:flex-row">
                    <div className="tw:bg-primary tw:p-3 tw:text-white tw:lg:w-1/4">
                        ...
                        <div className="tw:mt-2 tw:flex tw:items-center tw:justify-between tw:text-xs">
                            <a
                                ...
                                className="tw:text-white tw:hover:underline"
                            >
                                Contact us
                            </a>
                        </div>
            ...
            <div className="tw:w-full tw:lg:w-5/12">
                <div className="tw:bg-white-100 tw:h-full tw:rounded-lg tw:p-8 tw:shadow-xs">
                    ...
                    <div className="tw:mb-8">
                        ...
                        <div className="tw:mb-4 tw:grid tw:grid-cols-2 tw:gap-4">
                            <div className="tw:rounded-lg tw:bg-white tw:p-4 tw:text-center tw:shadow-xs">
