...
const TranslatorResults: React.FC<TranslatorResultsProps> = ({
    ...
    return (
        <div className="tw-space-y-6">
            ...
            {resultSource === "ai" && (
                <div className="tw-space-y-2">
                    ...
                    <p className="tw-text-xs tw-text-gray-500">
                        This translation was generated by AI. Review all content carefully — verify
                        metrics, certifications, and job titles against your actual experience before
                        using on a resume.
                    </p>
                </div>
            )}
            ...
            {warnings.length > 0 && (
                <div
                    className="tw-flex tw-items-center tw-gap-3 tw-rounded-lg tw-border tw-border-yellow-400 tw-bg-yellow-50 tw-px-4 tw-py-3"
                    role="status"
                    aria-live="polite"
                >
