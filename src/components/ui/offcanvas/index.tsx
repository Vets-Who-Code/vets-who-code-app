            ...
            <AnimatePresence initial={false}>
                {isOpen && (
                    ...
                    >
                        <motion.div
                            className={clsx(
                                "tw-relative tw-z-30 tw-w-[300px] tw-ml-auto sm:tw-w-[360px] tw-h-full tw-bg-secondary tw-bg-[url('https://res.cloudinary.com/vetswhocode/image/upload/v1698904153/mobile-image_ssvugk.png')] tw-bg-no-repeat tw-bg-top tw-bg-cover",
