                ...
                {show && (
                    <>
                        ...
                        <motion.div
                            ...
                            variants={fadeIn02}
                        >
                            <div className="modal-dialog tw:pointer-events-none tw:relative tw:z-50 tw:m-3 tw:flex tw:min-h-[calc(100vh-1rem)] tw:w-auto tw:items-center tw:sm:mx-auto tw:sm:my-5 tw:sm:min-h-[calc(100vh-3.5rem)] tw:sm:max-w-[500px] tw:lg:max-w-[1000px]">
                                <div
