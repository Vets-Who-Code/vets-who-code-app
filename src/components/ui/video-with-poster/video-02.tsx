...
const Video02 = forwardRef<HTMLDivElement, TProps>(({ poster, video, className }, ref) => {
    return (
        <div
            className={clsx(
                "tw:group tw:relative tw:z-20 tw:overflow-hidden tw:rounded-sm tw:shadow-xxl tw:shadow-black/22",
                className
            )}
            ref={ref}
        >
