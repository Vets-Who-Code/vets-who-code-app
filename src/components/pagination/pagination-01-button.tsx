            ...
            <ul className={clsx("pagination tw:text-center tw:text-[16px]", className)}>
                <li className="tw:inline-block tw:px-[5px]">
                    <button
                        type="button"
                        className={clsx(
                            "tw:block tw:h-12 tw:w-12 tw:rounded-full tw:text-center tw:font-extrabold tw:uppercase tw:leading-[48px] tw:-tracking-tightest tw:text-gray-400 tw:hover:text-heading",
                ...
                {Array.from({ length: numberOfPages }, (_, i) => (
                    <li className="tw:inline-block tw:px-[5px]" key={`page-number-${i + 1}`}>
                        <button
                            type="button"
                            className={clsx(
                                "tw:block tw:h-12 tw:w-12 tw:rounded-full tw:text-center tw:font-extrabold tw:uppercase tw:leading-[48px] tw:-tracking-tightest tw:hover:text-heading",
