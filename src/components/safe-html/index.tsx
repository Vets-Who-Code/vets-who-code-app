...
const sanitizeForClient = (dirty: string): string => {
    ...
    const DOMPurify =
        typeof DOMPurifyFactory === "function" ? DOMPurifyFactory(window) : DOMPurifyFactory;
...
const SafeHTML: React.FC<SafeHTMLProps> = ({ content, className, as: Component = "div" }) => {
