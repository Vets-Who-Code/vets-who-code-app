...
const StatusBar = ({ total }: Props) => (
    <div className="tw-w-full tw-border-b tw-border-cream/10 tw-bg-secondary tw-py-2.5">
        <div className="tw-container tw-flex tw-flex-wrap tw-items-center tw-gap-x-6 tw-gap-y-2 tw-font-mono tw-text-[10.5px] tw-uppercase tw-tracking-[0.1em] tw-text-[#DEE2E6]">
