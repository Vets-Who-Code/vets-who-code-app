    ...
    return (
        <section className="tw-bg-secondary tw-pt-20 md:tw-pt-24">
            <div className="tw-container">
                ...
                {/* Lede */}
                <p className="tw-mt-8 tw-max-w-[720px] tw-font-body tw-text-[#DEE2E6] [font-size:clamp(18px,1.6vw,22px)] tw-leading-[1.5]">
                ...
                <div className="tw-mt-14 tw-grid tw-grid-cols-2 md:tw-grid-cols-5 tw-border-t tw-border-cream/10">
                    ...
                    />
                    <Cell label="Branches" value={String(branchCount)} sub={branchSub} />
                    <Cell
                    ...
                    />
                    <Cell label="Salary Data" value="$45K–$280K" sub="via Lightcast" />
                </div>
            </div>
        </section>
    );
