    ...
    return (
        <>
            ...
            <div className="tw:flex tw:flex-wrap">
                <div className="tw:mb-7.5 tw:w-full tw:shrink-0 tw:sm:mb-0 tw:sm:mr-7.5 tw:sm:w-[200px] tw:md:mr-[70px]">
                ...
                <div className="tw:grow">
                    <p className="tw:font-medium tw:text-secondary tw:sm:mb-[42px]">
                        Detailed Rating
                    </p>
            ...
            {items.length > 0 && (
                <ul className="course-reviews-list tw:mt-[50px]">
                    {items.map((item) => (
                        <li
                            key={item.id}
                            className="tw:mb-7.5 tw:mt-2.5 tw:border-b tw:border-b-gray-500 tw:pb-7 tw:pl-[5px] tw:pr-5 tw:pt-5 tw:first:mt-0 tw:last:mb-0"
                        >
                            <Review {...item} />
                        </li>
                    ))}
