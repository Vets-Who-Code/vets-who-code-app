import { DemandBars, demandLevel, SectionHeader } from "./section-helpers";
...
const matchClass = (m: string) => {
    ...
    if (l.includes("high")) return "#FDB330";
    if (l.includes("good")) return "#0353A4";
    return "#DEE2E6";
};
                                ...
                                <div className="tw-mt-auto tw-flex tw-flex-col tw-gap-2 tw-border-t tw-border-dashed tw-border-cream/10 tw-pt-3">
                                    ...
                                    <ul className="tw-flex tw-flex-col tw-gap-1">
                                        {p.skillsToClose.slice(0, 3).map((s) => (
                                            <li
                                                key={s}
                                                className="tw-font-body tw-text-[11.5px] tw-leading-[1.4] tw-text-[#DEE2E6]"
                                            >
                                                — {s}
                                            </li>
                                        ))}
