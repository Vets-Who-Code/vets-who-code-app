    ...
    return (
        <Section className="app-download-area" space={space} bg={bg}>
            <div className="tw:container tw:grid tw:grid-cols-1 tw:items-center tw:gap-[50px] tw:lg:grid-cols-12 tw:lg:gap-7.5">
                <motion.div
                    className="tw:relative tw:z-10 tw:lg:col-span-7"
                    initial="offscreen"
                ...
                >
                    ...
                    <motion.div
                        className="tw:absolute tw:bottom-2.5 tw:left-5 tw:-z-1 tw:h-[200px] tw:w-[200px] tw:md:bottom-0 tw:md:h-[476px] tw:md:w-[476px]"
                        animate={{
                            x: trans1().x,
                            y: trans1().y,
                        }}
                    ...
                    <motion.div
                        className="tw:absolute tw:bottom-[40%] tw:left-0 tw:-z-1 tw:md:left-[-150px]"
                        animate={{
                            x: trans2().x,
                            y: trans2().y,
                        }}
                    ...
                    <motion.div
                        className="tw:absolute tw:bottom-5 tw:right-7.5 tw:-z-1 tw:w-20 tw:md:bottom-0 tw:md:right-[15%] tw:md:w-auto"
                        animate={{
                            x: trans1().x,
                            y: trans1().y,
                        }}
