    ...
    return (
        <Section className="contact-info-area" space="none">
            <div className="tw:container">
                {section_title && (
                    <motion.h2
                        className="tw:mx-auto tw:mb-10 tw:max-w-[770px] tw:text-center tw:leading-none tw:md:mb-15"
                        initial="offscreen"
                ...
                <motion.div
                    className="tw:mb-10 tw:grid tw:grid-cols-1 tw:gap-x-7.5 tw:gap-y-10 tw:md:mb-15 tw:md:grid-cols-3"
                    initial="offscreen"
                    whileInView="onscreen"
                    viewport={{ once: true, amount: 0.4 }}
                    variants={scrollUpVariants}
                ...
                <motion.div
                    className="tw:h-[300px] tw:lg:h-[400px]"
                    initial="offscreen"
                    whileInView="onscreen"
                    viewport={{ once: true, amount: 0.4 }}
                    variants={scrollUpVariants}
