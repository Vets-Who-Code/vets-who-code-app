...
export default async function handler(req: NextApiRequest, res: NextApiResponse<OGFetchResponse>) {
    ...
    try {
        ...
        const response = await fetch(url, {
            headers: {
                "User-Agent":
                    "Mozilla/5.0 (compatible; VetsWhoCodeBot/1.0; +https://vetswhocode.io)",
            },
        ...
        const metadata: URLMetadata = {
            ...
            image:
                ...
                undefined,
            siteName: getMeta('meta[property="og:site_name"]') || urlObj.hostname,
            favicon:
