...
const BlogImagesAdminPage: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      {/* Header */}
      <div style={{ backgroundColor: 'white', borderBottom: '1px solid #e0e0e0', padding: '20px' }}>
        ...
        {activeTab === 'stats' && stats && (
          <div style={{ backgroundColor: 'white', borderRadius: '8px', padding: '30px' }}>
            ...
            >
              ...
              >
                <h3 style={{ margin: '0 0 10px 0', fontSize: '36px', color: '#1976d2' }}>
                  {stats.total}
                </h3>
              ...
              >
                <h3 style={{ margin: '0 0 10px 0', fontSize: '36px', color: '#388e3c' }}>
                  {stats.cloudinary}
                </h3>
              ...
              >
                <h3 style={{ margin: '0 0 10px 0', fontSize: '36px', color: '#f57c00' }}>
                  {stats.local}
                </h3>
              ...
              >
                <h3 style={{ margin: '0 0 10px 0', fontSize: '36px', color: '#7b1fa2' }}>
              ...
              {allImages.map((img) => (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                    <div style={{ flex: 1 }}>
                      <h3 style={{ margin: '0 0 10px 0' }}>{img.blogTitle}</h3>
                      ...
                      {img.publicId && (
                        <p style={{ margin: 0, fontSize: '12px' }}>
                          <strong>Cloudinary ID:</strong> <code>{img.publicId}</code>
                        </p>
                      )}
                    </div>
                    <div
                      style={{
                        marginLeft: '20px',
                        padding: '5px 15px',
                        backgroundColor: img.isCloudinary ? '#4caf50' : '#f44336',
                        color: 'white',
                        borderRadius: '20px',
                        fontSize: '12px',
                        fontWeight: 'bold',
