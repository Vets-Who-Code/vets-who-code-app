    ...
    return (
        <div className="tw-flex tw-min-h-screen tw-items-center tw-justify-center tw-bg-gray-100">
            <div className="tw-rounded-lg tw-bg-white tw-p-8 tw-shadow-md tw-text-center">
                ...
                <h1 className="tw-mb-4 tw-text-2xl tw-font-bold tw-text-ink">Dev Access Enabled</h1>
                <p className="tw-mb-4 tw-text-gray-200">Setting up development bypass...</p>
                <p className="tw-text-sm tw-text-gray-500">Redirecting to job board...</p>
            </div>
        </div>
    );
};
