        ...
        >
            ...
            <div className="tw:container">
                <div className="tw:grid tw:grid-cols-12">
                    <TextWidget
                        mode={mode}
                        className="tw:col-span-12 tw:mb-[43px] tw:lg:col-span-5 tw:xl:col-span-5"
                    />
                    <TwoColumnListWidget
                        mode={mode}
                        className="tw:col-span-12 tw:mb-[25px] tw:md:col-span-7 tw:lg:col-span-4 tw:xl:col-span-3"
                    />

                    <ListWidget
                        mode={mode}
                        className="tw:col-span-12 tw:mb-7.5 tw:md:col-span-5 tw:lg:col-span-3"
                    />
                    <div className="tw:sm:col-span-2 tw:xl:col-span-1 tw:maxSm:col-span-3">
                        <a
