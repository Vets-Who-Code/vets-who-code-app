  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={color || `currentColor`}
      />
      <circle cy={45.5} cx={48.5} fill="#fff" transform="rotate(-45.017 48.523 45.455)" r={8.6} />
      <circle cy={88.6} cx={48.5} fill="#fff" transform="rotate(-45.017 48.521 88.576)" r={8.6} />
    </svg>
  )
}
