---
title: "The 10-Day Sprint: What to Fix Before Labor Day"
postedAt: "2026-08-22T10:00:00.000Z"
author: "Jerome Hardaway"
description: "The September Surge is still real, but it got picky. Ten days of focused work to make your judgment legible to a market that pays a premium for it."
image:
...
Here's the part that explains why so much career advice from 2022 is now actively harmful.

Lightcast's research on skill velocity found that about a third of the skills required for the average U.S. job changed between 2021 and 2024. For the most AI-exposed quarter of occupations, three quarters of the required skills changed. In four years. That's not a job market evolving — that's a job market being rewritten while people are standing in it.

What survived the rewrite is instructive. It wasn't the routine execution skills — the report formatting, the first-draft writing, the data entry, the boilerplate code. AI absorbed that layer. What survived, and what's now commanding the premium, are the skills that sit on top of the execution layer: deciding what's worth doing, verifying that what got done is actually right, and explaining the result to someone who needs to act on it.
...
### The part that should make you sit up straight

The rough news in this cycle is landing hardest on early-career workers, and the mechanism is worth understanding because it's the mirror image of your situation.

Employment among 22-to-25-year-olds in AI-exposed occupations — customer support, basic accounting, junior analyst work, entry-level coding — is running roughly 19% below where it would be without AI exposure, according to Stanford payroll-data research. Companies aren't running mass layoffs to get there. They're doing something quieter: when the junior seat opens up, they don't backfill it. The tasks get absorbed by AI plus one mid-level person. Economists are calling it "hiring avoidance," and it doesn't make headlines because nothing dramatic happens. The door just doesn't open.
...
You've briefed a decision-maker who outranked you and didn't want to hear what you had to say. You've owned equipment worth more than the building you're sitting in. You've been responsible for people — their training, their readiness, their mistakes. You've worked a problem with incomplete information, a hard deadline, and consequences for being wrong. You've told a senior person their plan had a flaw, in the right tone, at the right moment, and lived to tell about it. You've made the call when the checklist ran out.

That is the judgment layer. Fully formed. Built over years, under pressure, with real stakes — which is the only way it gets built.

What you're missing is the technical layer underneath it. And here's the asymmetry that should change how you feel about this market: the technical layer is the teachable one. It has a curriculum. It takes months, not years. The judgment layer has no curriculum — it only comes from reps with real consequences, and the market just stopped subsidizing those reps for civilians.
...
Broad applications worked when the surge was broad. It isn't anymore, and the spray-and-pray approach now has a hidden cost: every generic application you send is time not spent on a targeted one, and targeted is the only kind getting read.

Pick fifteen organizations you can name a reason for. Legitimate reasons: they have a veteran hiring program with actual placement numbers, they're in your sector (defense, healthcare, logistics, fintech — wherever your domain knowledge transfers), they're in a metro you'd genuinely move to, someone from your network works there, or they're a federal contractor where your clearance history is worth real money. Write the reason next to each name in one sentence. Not a veteran? Same rule: pick companies where your domain context or network gives you a warm door.

If you can't write the sentence, the company doesn't make the list. "They're hiring" is not a reason. "They post a lot on LinkedIn" is not a reason.

Fifteen is the number because it's small enough that you can actually research each one — read their engineering blog, know their products, find their people — and large enough that a string of rejections doesn't zero out your pipeline. Ten is fine. Twenty-five means you didn't really choose.

While you're at it, note which of the fifteen have veteran ERGs or skillbridge relationships. Those are your warm doors for Day 8.

#### Day 2: Rewrite the top third of your resume

Nobody reads the bottom of a resume on the first pass. The first pass is six to eleven seconds, and it's spent entirely on the top third. That section is the document.

First, delete the objective statement if you have one. Anything resembling "transitioning service member seeking opportunities to leverage my leadership skills in a dynamic environment" — gone. That sentence does two kinds of damage: it tells the reader nothing concrete, and its posture is a request for a favor. You're not asking for a favor. You're offering scope and judgment they can't hire off a campus.

Replace it with a summary that leads with what you did and what happened because you did it. The formula is scope + outcome + stack:

> Led a 12-person maintenance section responsible for $40M in equipment at 98% operational readiness. Now building production AI systems in Python and FastAPI — most recently an evaluation harness that catches model errors before they reach users.

Two sentences. The first proves the judgment layer with numbers. The second proves the technical layer with specifics. Everything below it on the page is supporting evidence.
...
Do one role fully rather than five roles halfway. The first full translation is the hard one; it establishes your pattern, and the remaining roles will take a third of the time when you get to them after the sprint.
...
So build something small that verifies instead of generates. Concrete options, any one of which fits in a day:

- **An eval script.** Take an AI-powered feature (yours or a public one), write 25–50 test cases with known-good answers, score the model against them, and report the results. Bonus: show the score before and after you improved the prompt or added retrieval.
...
> AI Engineer | Python, FastAPI, RAG pipelines | Army veteran — 8 years leading technical teams
...
#### Day 6: Fix the proof layer

Pin three repositories. Exactly three — the eval artifact from Day 4, your best full project, and one more that shows range. Archive or unpin the tutorial clones, the abandoned to-do apps, and anything with a commit history that ends fourteen months ago.
...
#### Day 7: Record yourself explaining it

Three minutes. Screen recording — phone propped against a coffee mug is fine. Walk through your best project as if the person watching controls the budget and has never written a line of code.

Structure the three minutes: the problem in plain language (30 seconds), what you built and one decision you made along the way (90 seconds), what happened and what you'd do next (60 seconds). No code on screen for the first minute.

Why this specific rep: explaining technical work to non-technical stakeholders shows up on nearly every 2026 skills-demand list, and it has the widest gap between how much employers want it and how many candidates ever practice it. It's also — and this is the part you should internalize — the exact skill you built every time you briefed someone up the chain who needed the situation, not the details. You've done this rep hundreds of times. You've just never done it about software.

Watch the recording once (yes, it's uncomfortable; do it anyway), note where you rambled, and record it a second time. You don't have to publish either take. The point is that when an interviewer says "walk me through this project," the clean version comes out on the first try — because for you, it's the third try.
...
#### Day 9: Prepare for the four AI questions

Interviews in 2026 have converged on a small set of questions that are really one question — can I trust you with the output? — wearing four costumes. Write out real answers, each with a specific example attached, and say them out loud once:
...
#### Day 10: Set your surge cadence

The sprint ends. The window opens. The hiring wave runs from the week after Labor Day into early November, and the people who convert it are the ones who decided their daily routine before it started — because deciding it fresh at 9 p.m. on a hard day is how routines die.

Set something small enough to hold for six weeks without heroics:

- **Two tailored applications** — tailored meaning the top third of the resume speaks to that posting, which takes fifteen minutes now that Day 2 and Day 3 built the pattern.
- **One human contacted** — the Day 8 formula, sustained. Over six weeks that's thirty real conversations, and thirty conversations is a network.
- **One hour building** — the eval harness grows, the third repo gets its README, the skills stay warm. When an interviewer asks what you're working on, the answer is this week's work.
- **One line in a log** — what you sent, who you talked to, what moved. On the days when nothing seems to be happening, the log is the proof that it is.

Write the cadence down and put it where you'll see it. Then protect it the way you'd protect any battle rhythm: the routine is what carries you on the days motivation doesn't.

### What this actually adds up to

Ten days. Fifteen researched targets. A resume that opens with scope and outcome instead of a request. One role fully translated into civilian value. One artifact that proves you can be accountable for a machine's output. A profile that shows up in the searches recruiters actually run. Three repos a budget-holder can read to the end. One explanation rehearsed until it's clean. Five real conversations started. Four judgment questions answered before they're asked. And a cadence built to survive contact with October.

None of that is a career change. All of it is a positioning change — and in a market this targeted, positioning is most of the distance between the pile and the shortlist.

Here's the frame to carry into September. The 2026 market has a shortage, and the shortage isn't Python — Python is everywhere. The shortage is people who can be trusted with the output: to verify it, to own it, to explain it, to know when not to ship it. You spent years being exactly that person, under conditions most candidates can't imagine. The market can't see it yet because it's written in a language the market doesn't read. Whether you earned that judgment in uniform or in another high-stakes domain, the translation steps above make it visible.

Ten days is enough to translate it. The surge starts September 8. Be legible by then, and it works for you instead of around you.
