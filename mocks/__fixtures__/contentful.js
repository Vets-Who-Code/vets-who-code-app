  ...
  blogPost: {
    ...
    items: [
                ...
                content: [
                  {
                    ...
                    marks: [],
                    value:
                      'Some APIs allow you to add to a database. An example of this is the ',
                    nodeType: 'text',
                  },
                  {
                    data: {
                  ...
                  },
                  {
                    ...
                    marks: [],
                    value:
                      ', which allows you to add Twitter posts to your feed via the API.',
                    nodeType: 'text',
                  },
                ],
                nodeType: 'paragraph',
                ...
                content: [
                  {
                    nodeType: 'text',
                    value:
                      "Eddie and I took NSF's WordPress site and fixed one of their plugins (",
                    marks: [],
                    data: {},
                  },
                  {
                ...
                content: [
                  {
                    nodeType: 'text',
                    value:
                      "Lastly, it's important for the event to actually be ",
                    marks: [],
                    data: {},
                  },
                  {
      ...
      },
      {
        ...
        fields: {
          title:
            'The Top 5 Things You Need to Know to Be Successful as a Junior Developer',
          author: {
            metadata: {
              tags: [],
            },
                ...
                content: [
                  {
                    nodeType: 'text',
                    value:
                      "I've used this same soft skill working on Vets Who Code. I  go to our ",
                    marks: [],
                    data: {},
                  },
                  {
              ...
              },
              {
                ...
                content: [
                  ...
                  },
                  {
                    ...
                    marks: [],
                    value:
                      ' blog. I am excited to see what these troops can do.',
                    nodeType: 'text',
                  },
                ],
                nodeType: 'paragraph',
                ...
                content: [
                  {
                    ...
                    marks: [],
                    value:
                      'The most important thing you can do to support our mission is ',
                    nodeType: 'text',
                  },
                  {
                    data: {
                            ...
                            content: [
                              {
                                ...
                                marks: [],
                                value:
                                  'Intro to AWS Lambda and Serverless Apps ',
                                nodeType: 'text',
                              },
                            ],
                            nodeType: 'hyperlink',
