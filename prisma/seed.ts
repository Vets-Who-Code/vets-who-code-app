...
async function main() {
  ...
  // 1. Clean existing LMS data (in correct order to avoid foreign key constraints)
  ...
  // 4. Create comprehensive Web Development course
  console.log('📚 Creating Web Development Fundamentals course...');
  const webDevCourse = await prisma.course.create({
    data: {
      title: 'Web Development Fundamentals',
      description: 'Complete web development course covering HTML, CSS, JavaScript, React, and Node.js. Perfect for veterans transitioning to tech careers.',
  ...
  const assignments = await Promise.all([
    prisma.assignment.create({
      data: {
        ...
        instructions: 'Build a complete portfolio page that includes:\n- Semantic HTML structure\n- Header with navigation\n- About section\n- Projects section\n- Contact form\n\nUse proper HTML5 semantic elements.',
        courseId: webDevCourse.id,
    ...
    prisma.assignment.create({
      data: {
        ...
        instructions: 'Create a fully styled calculator interface:\n- Use CSS Grid or Flexbox\n- Responsive design\n- Modern styling with hover effects\n- Clean, professional appearance',
        courseId: webDevCourse.id,
    ...
    prisma.assignment.create({
      data: {
        ...
        instructions: 'Build a functional todo app with:\n- Add new todos\n- Mark todos as complete\n- Delete todos\n- Filter todos (all, active, completed)\n- Use local storage for persistence',
        courseId: webDevCourse.id,
    ...
    prisma.assignment.create({
      data: {
        ...
        instructions: 'Create a full-stack blog application:\n- React frontend with routing\n- Node.js/Express backend\n- Database integration\n- CRUD operations for posts\n- User authentication\n- Deploy to a hosting platform',
        courseId: webDevCourse.id,
  ...
  // 8. Create some progress records
  ...
  await prisma.note.create({
    data: {
      ...
      content: 'Remember: Always use semantic HTML for better accessibility and SEO. The <header>, <nav>, <main>, and <footer> elements are your friends!',
    },
  });

  // 11. Create a sample submission
  ...
  console.log('\n📊 Summary:');
  console.log({
    cohort: { name: cohort.name, isElite: cohort.isElite },
    users: {
    ...
    course: {
      ...
      difficulty: webDevCourse.difficulty,
